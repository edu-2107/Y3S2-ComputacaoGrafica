...
export class MyScene extends CGFscene {
    ...
    initMaterials() {
        ...
        this.material4.setAmbient(0.5, 0.3, 0.1, 1.0);
        ...
        this.materials.push(this.woodMaterial);
    ...
    display() {
        ...
        this.setGlobalAmbientLight(this.componentL,this.componentL,this.componentL, 1.0);
        this.lights[0].update();
        this.lights[1].update();
